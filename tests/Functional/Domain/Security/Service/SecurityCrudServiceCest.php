...
namespace App\Tests\Functional\Domain\Security\Service;
...
class SecurityCrudServiceCest
{
    ...
    public function entityByDto(FunctionalTester $I, Example $example): void
    {
        ...
        $I->assertEquals('on' === $example['status'] ? 'on' : null, $dtoSaved->status);
        $I->assertEquals('on' === $example['status'] ? 'on' : null, $dtoSaved->notify);
    }
