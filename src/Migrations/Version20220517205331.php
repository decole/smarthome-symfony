 ...
 */
final class Version20220517205331 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'add sensor table';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN sensor.updated_at IS \'(DC2Type:datetime_immutable)\'');
