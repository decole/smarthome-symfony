...
class PlcCrudValidationService implements ValidationInterface
{
    private CrudPlcDto $dto;

    public function __construct(private ValidatorInterface $validator, private PlcRepositoryInterface $repository)
    {
    }
